...
import Fix.function_btn.template as tp  
from Fix.function_btn.print import print
from Fix.function_btn.ocr import perform_ocr
from Fix.function_btn.nms import non_max_suppression
