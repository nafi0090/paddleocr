...
if uploaded_image is not None:
    ...
    st.image(img, caption='Citra Asli', use_column_width=True)
    ...
    coordinates = template_match_multi_scale(resized_image, template, threshold)
    ...
    if len(coordinates) == 0:
        ...
        for i, box in enumerate(selected_boxes):
            ...
            # arr_cash.append(array_nominal)
            # arr_cash_1.append(array_nominal)
